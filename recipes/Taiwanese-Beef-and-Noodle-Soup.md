...
image: https://ik.imagekit.io/webtactics/changs/static/img/recipes/Taiwanese-Beef-and-Noodle-Soup/Taiwanese-Beef-and-Noodle-Soup.jpg
serves: "6"
preptime: "3+ hours"
difficulty: "Easy"
author: "pwg"
ingredients: |
  ...
  <h3>Beef Broth:</h3>
  <ul>
  <li>1 kg beef brisket or beef cheeks</li>
  <li>1 carrot, peeled and roughly chopped</li>
  <li>1 tomato, cut into chunks</li>
  <li>3 cloves garlic, crushed or finely chopped</li>
  <li>&frac12; thumb ginger, sliced</li>
  ...
  <li>2 tsp. honey</li>
  <li>60ml (&frac14; cup) red wine</li>
  <li>1 tsp. five spice powder</li>
  </ul>
  <h3>To serve:</h3>
  <ul>
  <li>1 packet <a href="/products/Changs-Egg-Noodles/" title="Chang's Egg Noodles" alt="Chang's Egg Noodles">Chang's Egg Noodles</a></li>
  <li>1 bunch baby bok choy, quartered lengthways</li>
  <li>Chilli, sliced (optional)</li>
  </ul>
method: |
  <h3>Method:</h3>
  <ol>
  <li>Combine the broth ingredients in a large pot and cover with cold water. Bring to boil, skimming any grey scum that forms on top and discarding.</li>
