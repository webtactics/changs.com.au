...
difficulty: "Easy"
author: "pwg"
gallery: "recipes/Aussie-Summer-Pork-and-Pineapple-Skewers"
ingredients: |
  <h3>Ingredients:</h3>
  <ul>
  <li>400-500g pork neck, diced into 3cm chunks</li>
  <li>1 large red capsicum cut into 3cm cubes</li>
  <li>1 large green capsicum cut into 3cm cubes</li>
  <li>1-2 red onions cut into 3cm cubes</li>
  <li>&frac12; a large pineapple, cut into 3cm cubes</li>
  </ul>
  <h3>Sauce:</h3>
  <ul>
...
method: |
  <h3>Method:</h3>
  <ol>
  <li>In a bowl combine the soy sauce, oyster sauce, sesame oil and pineapple juice and marinate the pork for 30min in the fridge. In the meantime, prepare the vegetables and pineapple.</li>
  <li>Thread pork, vegetables and pineapple onto skewers in a repeated pattern.</li>
  <li>Barbeque high on grill for 2min each side (a total of 8-10min cooking time)</li>
  </ol>
  <h3>Optional:</h3>
  <ul>
  ...
  <h3>Method:</h3>
  <ol>
  <li>Boil noodles according to packet instructions and drain.</li>
