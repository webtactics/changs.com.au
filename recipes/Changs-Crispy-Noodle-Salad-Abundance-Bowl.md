...
image: https://ik.imagekit.io/webtactics/changs/static/img/recipes/Changs-Crispy-Noodle-Salad-Abundance-Bowl/Changs-Crispy-Noodle-Salad-Abundance-Bowl-2.jpg
serves: "4 individual lunch bowls"
preptime: "20 minutes"
difficulty: "Easy"
author: "pwg"
gallery: "recipes/Changs-Crispy-Noodle-Salad-Abundance-Bowl"
ingredients: |
  <h3>Ingredients:</h3>
  <ul>
  ...
  <li>&frac12; - &frac34; Chinese cabbage, thinly shredded</li>
  <li>4 green onions, thinly sliced</li>
  <li>&frac12; - &frac34; cup slivered almonds</li>
  ...
  <li>1 large carrot, sliced into ribbons using a peeler</li>
  <li>1 red chilli, sliced thinly</li>
  <li>1 lime, sliced into 4 wedges</li>
  <li>Handful of Thai mint leaves</li>
  </ul>
method: |
  <h3>Method:</h3>
  <ol>
  <li>Finely shred the cabbage and evenly divide between 4 bowls. Add the spring onions and almonds. Garnish with carrot ribbons, chilli and mint leaves.</li>
  <li>Divide packet of crispy noodles between the bowls and serve dressing on the side for each to add to their own salad.</li>
