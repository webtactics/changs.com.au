...
image: "/static/img/recipes/Black-Pepper-Crab/Black-Pepper-Crab.jpg"
serves: "2"
preptime: "40 minutes"
difficulty: "Medium"
...
ingredients: |
  <h3>Ingredients:</h3>
  <ul>
  <li>1 large mud crab 1-1.5 kilos or 3 large blue swimmer crabs, cleaned and cut in 4 pieces each with shells cracked with the back of a cleaver</li>
...
method: |
  <h3>Method:</h3>
  <ol>
  <li>Heat a wok that has a lid and add the oil, and then the crab. You might have to cook the crab in a couple of batches.</li>
  <li>Stir fry until the shells turn orange and don&rsquo;t worry that the meat inside isn&rsquo;t cooked.</li>
