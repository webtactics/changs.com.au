...
difficulty: "Simple"
author: "pwg"
gallery: "recipes/Changs-Abundance-Bowl"
ingredients: |
  <h3>Ingredients:</h3>
  <p><strong>Salad:</strong></p>
  <ul>
  <li>1 Lebanese cucumber, cut into matchsticks</li>
  <li>1 carrot, cut into matchsticks</li>
  <li>&frac14; red cabbage, sliced thinly</li>
  <li>a handful of bean sprouts and coriander leaves</li>
  </ul>
  <p>Note: It is easier and faster to use a mandoline slicer to slice the cabbage, carrot and cucumber if you have one available.</p>
  <p><strong>Chang's Fried Noodle Salad:</strong></p>
  <ul>
  ...
  <li>&frac14; cup <a title="Chang's Crispy Noodle Salad Dressing" href="/products/changs-crispy-noodle-salad-dressing/">Chang's Crispy Noodle Salad Dressing</a></li>
  </ul>
  <p>Combine all ingredients. Evenly coat salad with dressing.</p>
  <p><strong>Chang's Konjac 2 minute Noodles</strong></p>
  <ul>
  <li>1 pkt Chang's Traditional Low Cal Noodles, drained and rinsed<br />1 tbs Chang's Soy Sauce<br />1 tbs toasted sesame seeds</li>
  </ul>
  <p>Combine all ingredients in a pot and cook over high heat for 2 minutes.</p>
  <p><strong>Garnish:</strong></p>
  <ul>
  <li>3-4 tbs Chang's Fried Noodle Salad Dressing served on the side for extra dressing options.</li>
  </ul>
  <p>Optional to add a handful of baby rocket leaves at the base of abundance bowl for added greens option.</p>
method: |
  <h3>Method:</h3>
  <ol>
